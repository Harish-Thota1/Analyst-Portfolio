...
You know that moment when someone says *"The dashboard shows one number, but Excel shows another"* and everyone stops trusting the data? 

I fix that.

I build platforms where:
- ✅ Finance and Operations **stop arguing** about whose numbers are right
- ✅ Analysts **stop spending 40+ hours monthly** checking things manually  
- ✅ Managers **actually make decisions** instead of waiting for "better data"

**Currently:** Building Microsoft Fabric platforms in Adelaide, SA  
**Previously:** Manufacturing BI (3 years), Healthcare Compliance (1 year), Payroll Analytics

📧 harishthota001@gmail.com | 📱 0459 182 404 | 💼 [LinkedIn](https://linkedin.com/in/harish-thota-ds) | 📍 Adelaide, Australia

---

## 🎯 What's Inside This Portfolio

### **If you're a recruiter looking for someone who...**
- Can deliver **Microsoft Fabric** production platforms (did one in 30 days)
- Understands **healthcare compliance** (built system for $42M in transactions)
- Has **manufacturing BI** experience (3 years, automotive supply chain)
...
## 💡 Three Problems I've Solved (With Proof)

### **Problem #1: "Our forecasts are always wrong"**
**Company:** Grad Careers (Current Role)  
**Situation:** Coordinators making staffing decisions on 2-day-old Excel data with 4,000+ errors  
...
### **Problem #2: "We're always catching compliance issues too late"**
**Company:** Australian Institute for Machine Learning  
**Situation:** Analysts spending 40+ hours monthly manually checking $42M in transactions  
...
### **Problem #3: "We don't know which suppliers are late until it's too late"**
**Company:** Hyundai Mobis (3 Years)  
**Situation:** 40+ staff manually checking supplier deliveries, taking 2 days to fix problems  
...
**Languages I Use:**
- SQL for everything (queries, optimization, transformations)
- Python for data quality & automation
...
**Experience:**
- 5+ years building BI solutions
- $50M+ data managed annually
- 99% average platform uptime
- 100+ business users supported

**Impact:**
- 1,200+ compliance problems prevented
...
- Company that values **data quality** over just dashboards
- Team that wants **governance** not chaos
- Role where I can **build platforms** people trust

**What I Bring:**
- Microsoft Fabric hands-on experience (production, not tutorial)
- Healthcare compliance background (if you're in aged care/medical)
- Manufacturing know-how (if you're in supply chain/operations)
- Ability to translate "tech speak" to "business speak"

**Adelaide-based, available full-time, Subclass 485 visa**
...
- Microsoft Fabric roles (I've actually delivered one in production)
- Healthcare/aged care analytics (I understand compliance)
- Manufacturing BI (I've lived in procurement & warehouse teams)
- Any role where "nobody trusts the data" is a real problem

**Let's connect:**
- 📧 harishthota001@gmail.com
- 📱 0459 182 404
- 💼 [LinkedIn](https://linkedin.com/in/harish-thota-ds)
...
All examples use anonymized data. Company names are real, but specific details are generalized to protect proprietary information. Happy to discuss implementations in detail during interviews.
